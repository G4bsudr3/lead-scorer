...
async def init_data(profile: dict = Depends(get_current_user)):
    ...
    deal_cols = ["id", "opportunity_id", "deal_stage", "score", "product_name",
                 ...
                 "_f_pipeline_aging", "_f_win_rate_sector", "_f_win_rate_product",
                 "_f_win_rate_account", "_f_potential_value", "_f_account_fit",
                 "_f_agent_performance", "_f_repeat_customer", "_f_product_price_tier"]
