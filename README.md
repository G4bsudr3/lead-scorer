...
> Login com qualquer e-mail via OTP. Documentação técnica: [DOCS.md](DOCS.md)
...
- [ ] Git history (commits no repositório)
...
- [x] Build de produção limpo (TypeScript + Vite, zero erros)
